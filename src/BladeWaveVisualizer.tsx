...
export interface BladeWaveConfig {
  lineCount: number
  ...
  depthGradient?: string // Optional gradient override
  useDepthGradient: boolean // Toggle: true = depthGradient mode, false = primary/secondary gradient mode
...
export const DEFAULT_BLADEWAVE_CONFIG: BladeWaveConfig = {
  lineCount: 40,
  pointsPerLine: 128,
  lineSpacing: 12,
  waveHeight: 150,
  ...
  depthGradient: 'linear-gradient(90deg, rgb(139, 0, 0) 0%, rgb(255, 0, 0) 25%, rgb(255, 120, 0) 50%, rgb(255, 200, 0) 75%, rgb(255, 255, 0) 100%)',
