...
import type { Geometry3DLayer, GeometryShape, GeometryMaterial, ShadingType } from '../../../engines/astrofox/types'
import { GEOMETRY_SHAPES, GEOMETRY_MATERIALS, SHADING_TYPES } from '../../../engines/astrofox/types'
