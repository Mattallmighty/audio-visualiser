...
import { NeonterrainConfig, DEFAULT_NEONTERRAIN_CONFIG } from '../../_generated'

// Export with original name for backward compatibility
export type NeonTerrainConfig = NeonterrainConfig
export { DEFAULT_NEONTERRAIN_CONFIG }
...
const NeonTerrainVisualiser: React.FC<NeonTerrainProps> = ({
  ...
  const cfg = useMemo(
    () => ({ ...DEFAULT_NEONTERRAIN_CONFIG, ...config }),
    [config]
  )
