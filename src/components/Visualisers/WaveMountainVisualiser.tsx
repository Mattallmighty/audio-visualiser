...
import { WavemountainConfig, DEFAULT_WAVEMOUNTAIN_CONFIG } from '../../_generated'

// Export with original name for backward compatibility
export type WaveMountainConfig = WavemountainConfig
export { DEFAULT_WAVEMOUNTAIN_CONFIG }
...
const WaveMountainVisualiser: React.FC<WaveMountainProps> = ({
  ...
  const cfg = useMemo(
    () => ({ ...DEFAULT_WAVEMOUNTAIN_CONFIG, ...config }),
    [config]
  )
